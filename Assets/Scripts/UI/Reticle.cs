...
public class Reticle : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    playerRotationSpeed = GameObject.FindObjectOfType<PlayerController>().rotationSpeed;

    Vector3 initialReticlePosition = playerShip.transform.position + new Vector3(0, 0, initialDistanceFromPlayer);
  ...
  private void MoveIntentReticle()
  {
    ...
    rotationTransform.transform.LookAt(playerShip.transform);
    //}
  }
  ...
  private void MoveAimReticle()
  {
    ...
    Vector3 newPosition = Vector3.MoveTowards(currentPosition, intentReticlePosition, playerRotationSpeed);

    aimPosition.transform.position = newPosition;
    aimPosition.transform.LookAt(playerShip.transform);
  }
  ...
  {
    playerShip.transform.LookAt(aimPosition.transform);
  }
}
